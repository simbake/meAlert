                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" onchange="showfields()" id="access_level" name="access_level">
                                   <option value="MOH">MOH</option>
                                   <option value="County Administrator">County Administrator</option>
                                   <option value="Sub-County Administrator">Sub-County Administrator</option>
                        ...
                        <div class="form-group row" id="div_county">
                        ...
                        <div class="form-group row" id="div_subCounty">
                            <label for="subcounty" class="col-md-4 col-form-label text-md-right">{{ __('Sub-County') }}</label>
...
function showfields(){
  var value = document.getElementById('access_level').value;
  if(value == 'MOH' || value == 'KEMRI'){
    $('#div_county').hide();
    $('#div_subCounty').hide();
  }
  else if(value == 'County Administrator'){
    $('#div_county').show();
    $('#div_subCounty').hide();
  }
  else if(value == 'Sub-County Administrator'){
    $('#div_subCounty').show();
    $('#div_county').hide();
  }
  else{
